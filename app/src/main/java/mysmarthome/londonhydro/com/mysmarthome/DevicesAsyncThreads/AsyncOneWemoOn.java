 ...
 */
public class AsyncOneWemoOn extends AsyncTask<String ,Void,Void>
{
    int success=0;
    String message="null";
    String url_ac_wemo_on =  "https://maker.ifttt.com/trigger/ac_wemo_on/with/key/WUfKHhCQj6I147ATXA6Y5";
